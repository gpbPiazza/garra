	...
	return []*Token{
		{
			...
			Identifier:  MatriculaID,
			IsExtracted: false,
			Value:       defaultValue(MatriculaID),
		},
		{
			StartKeys:   []string{"Cláusula Geral: ESCRITURA PÚBLICA DE"},
			EndKeys:     []string{" que"},
			Identifier:  TitleAtoID,
			IsExtracted: false,
			Value:       defaultValue(TitleAtoID),
		},
		{
			StartKeys:   []string{"Data e hora do recebimento do ato pelo TJSC: "},
			EndKeys:     []string{" -"},
			Identifier:  DataProtocoloID,
			IsExtracted: false,
			Value:       defaultValue(DataProtocoloID),
		},
		{
			StartKeys:   []string{" "},
			EndKeys:     []string{"Endereço:"},
			StartOffset: "Serventia:",
			Identifier:  TabelionatoNameID,
			IsExtracted: false,
			Value:       defaultValue(TabelionatoNameID),
		},
		{
			StartKeys:   []string{"Município/UF:"},
			EndKeys:     []string{"Telefone(s):"},
			StartOffset: "Serventia:",
			Identifier:  TabelionatoCityUFID,
			IsExtracted: false,
			Value:       defaultValue(TabelionatoCityUFID),
		},
		{
			StartKeys:   []string{":"},
			EndKeys:     []string{"Nome do Livro:"},
			StartOffset: "Código do Livro",
			Identifier:  BookNumID,
			IsExtracted: false,
			Value:       defaultValue(BookNumID),
		},
		{
			StartKeys:   []string{"Página Inicial:"},
			EndKeys:     []string{"Página Final:"},
			StartOffset: "Código do Livro",
			Identifier:  InitialBookPagesID,
			IsExtracted: false,
			Value:       defaultValue(InitialBookPagesID),
		},
		{
			StartKeys:   []string{"Página Final:"},
			EndKeys:     []string{"Data do Registro:"},
			StartOffset: "Código do Livro",
			Identifier:  FinalBookPagesID,
			IsExtracted: false,
			Value:       defaultValue(FinalBookPagesID),
		},
		{
			StartKeys:   []string{"Data do Registro: "},
			EndKeys:     []string{"Nome do Imposto", ","},
			StartOffset: "Código do Livro",
			Identifier:  EscrituraMadeDateID,
			IsExtracted: false,
			Value:       defaultValue(EscrituraMadeDateID),
		},
		{
			StartKeys:   []string{"preço total, certo e ajustado de R$", "certo e ajustadode R$"},
			EndKeys:     []string{", ", "/"},
			StartOffset: "Cláusula Geral:",
			Identifier:  EscrituraValorID,
			IsExtracted: false,
			Value:       defaultValue(EscrituraValorID),
		},
		{
			StartKeys:   []string{"importância de R$"},
			EndKeys:     []string{" correspondente"},
			StartOffset: "Cláusula Geral:",
			Identifier:  ItbiValorID,
			IsExtracted: false,
			Value:       defaultValue(ItbiValorID),
		},
		{
			StartKeys:   []string{"Valor do Negócio: R$"},
			EndKeys:     []string{"Cláusula Geral:"},
			Identifier:  ItbiIncidenciaValorID,
			IsExtracted: false,
			Value:       defaultValue(ItbiIncidenciaValorID),
		},
		{
			StartKeys:   []string{"em favor de"},
			EndKeys:     []string{"como a seguir se"},
			Identifier:  InFavorToWhoID,
			StartOffset: "Cláusula Geral:",
			IsExtracted: false,
			Value:       defaultValue(InFavorToWhoID),
		},
		{
			StartKeys:   []string{"que faz"},
			EndKeys:     []string{"em favor de"},
			Identifier:  WhoDoesID,
			StartOffset: "Cláusula Geral:",
			IsExtracted: false,
			Value:       defaultValue(WhoDoesID),
		},
	}
}
